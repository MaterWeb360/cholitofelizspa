        ...
        <div class="wrp-seccion is-center">
          <div class="titulo_desp">
            <div class="title-seccion"><img src="<?php echo get_template_directory_uri(); ?>/images/Group-86.png" loading="lazy" alt="" class="title_alas">
              <h1 class="subtitle-seccion"><span>Explora nuestras</span><br><span class="subtitle-down-seccion">principales categorías</span></h1><img src="<?php echo get_template_directory_uri(); ?>/images/Group-85.png" loading="lazy" alt="" class="title_alas">
            </div>
          ...
          <div class="banner">
            <div class="banner_col is-text">
              <div class="etiqueta"><img src="<?php echo get_template_directory_uri(); ?>/images/estrella-1.svg" loading="lazy" alt="" class="etiqueta-icon">
                <div>Lo más amado por ellos</div>
              </div>
              <div class="titulobanner">
                <div>Los articulos favoritos de <span class="text-color-orange2">nuestros clientes</span></div>
              </div>
              <div>Productos seleccionados por su calidad, comodidad y felicidad garatizada.</div>
            </div>
            <div class="banner_col is-img"><img src="<?php echo get_template_directory_uri(); ?>/images/mo0delitos.png" loading="lazy" sizes="100vw"  alt="" class="banner_col-modelos"></div>
            <div class="secccion-bg_section"><img src="<?php echo get_template_directory_uri(); ?>/images/banners.jpg" loading="lazy" sizes="100vw" alt="" class="seccion-slider_fondo"></div>
          </div>
    ...
    <div class="padding-seccion is-small">
      <div class="container-seccion">
        <div class="wrp-seccion is-horizontal-center">
          <div class="descuento-item"><img src="<?php echo get_template_directory_uri(); ?>/images/etiqueta-1.svg" loading="lazy" alt="" class="descuento-icon">
            <div><strong>30% de<br>‍</strong>‍<span class="text-span"><strong>decuento </strong></span></div>
          </div><img src="<?php echo get_template_directory_uri(); ?>/images/Group-56.png" loading="lazy" alt="" class="franja_line">
  ...
  <section class="seccion">
    <div class="padding-seccion">
      <div class="container-seccion">
        <div class="wrp-seccion">
          <div class="scroll">
            <div class="scroll-anuncio"><img src="<?php echo get_template_directory_uri(); ?>/images/Rectangle-25.png" loading="lazy" sizes="100vw" alt="">
  ...
  <section class="seccion is-transparencia">
    <div class="padding-seccion">
      <div class="container-seccion">
        <div class="wrp-seccion is-center">
          <div class="title-seccion"><img src="<?php echo get_template_directory_uri(); ?>/images/Group-86.png" loading="lazy" alt="" class="title_alas">
            <h1 class="subtitle-seccion"><span>Transparencia</span><br><span class="subtitle-down-seccion">que da confianza</span></h1><img src="<?php echo get_template_directory_uri(); ?>/images/Group-85.png" loading="lazy" alt="" class="title_alas">
          </div>
          <div class="grid-4 gap-1-5rem">
            <div class="transp"><img src="<?php echo get_template_directory_uri(); ?>/images/Frame-80.svg" loading="lazy" alt="" class="transp_iconj">
              <div class="transp_txt">
                <div class="transp_tarjeta-title">Envíos rápidos y confiables</div>
                <div>Recibe tus productos en <span class="text-color-orange bold">24 a 48 horas.</span> Rápido, seguro y sin complicaciones.</div>
              </div>
            </div>
            <div class="transp"><img src="<?php echo get_template_directory_uri(); ?>/images/transparencia-seguridad.svg" loading="lazy" alt="" class="transp_iconj">
              <div class="transp_txt">
                <div class="transp_tarjeta-title">Compra 100% <br>segura</div>
                <div>Tus <span class="text-color-orange bold">datos y pagos están protegidos</span> con los mas altos estándares de seguridad.</div>
              </div>
            </div>
            <div class="transp"><img src="<?php echo get_template_directory_uri(); ?>/images/transparencia-moviilidad.svg" loading="lazy" alt="" class="transp_iconj">
              <div class="transp_txt">
                <div class="transp_tarjeta-title">Productos de <br>calidad</div>
                <div>Seleccionamos lo mejor para la <span class="text-color-orange bold">salud, bienestar y felicidad </span>de tu mascota.</div>
              </div>
            </div>
            <div class="transp"><img src="<?php echo get_template_directory_uri(); ?>/images/transparencia-carino.svg" loading="lazy" alt="" class="transp_iconj">
              <div class="transp_txt">
                <div class="transp_tarjeta-title">Hecho con <br>amor</div>
                <div><span class="text-color-orange bold">Amamos a las mascotas</span> y eso se refleja en cada producto y cada detalle.</div>
              </div>
            </div>
          </div>
          <div class="transp_msg"><img src="<?php echo get_template_directory_uri(); ?>/images/Frame-171.svg" loading="lazy" alt="">
            <div>Miles de familias y mascotas felices <strong>nos recomiendan.</strong></div><img src="<?php echo get_template_directory_uri(); ?>/images/line.svg" loading="lazy" alt="">
            <div><strong>Tu confianza</strong> es nuestro mayor compromiso.</div>
          </div>
          <div class="transp_confianza">
            <div class="transp_confianza-bx"><img src="<?php echo get_template_directory_uri(); ?>/images/estrella.svg" loading="lazy" alt="" class="transp_confianza-icon">
              <div>Los mejores articulos para tu mascota.</div>
            </div><img src="<?php echo get_template_directory_uri(); ?>/images/line-orange.svg" loading="lazy" alt="" class="transp_confianza-line">
            <div class="transp_confianza-bx"><img src="<?php echo get_template_directory_uri(); ?>/images/escudo.svg" loading="lazy" alt="" class="transp_confianza-icon">
              <div>Los mejores articulos para tu mascota.</div>
            </div><img src="<?php echo get_template_directory_uri(); ?>/images/line-orange.svg" loading="lazy" alt="" class="transp_confianza-line">
            <div class="transp_confianza-bx"><img src="<?php echo get_template_directory_uri(); ?>/images/mensaje.svg" loading="lazy" alt="" class="transp_confianza-icon">
              <div>Los mejores articulos para tu mascota.</div>
            </div><img src="<?php echo get_template_directory_uri(); ?>/images/line-orange.svg" loading="lazy" alt="" class="transp_confianza-line">
            <div class="transp_confianza-bx"><img src="<?php echo get_template_directory_uri(); ?>/images/corazon.svg" loading="lazy" alt="" class="transp_confianza-icon">
              <div>Los mejores articulos para tu mascota.</div>
            </div>
          </div>
        </div>
